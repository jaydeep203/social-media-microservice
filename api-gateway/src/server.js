...
const proxyOptions = {
    ...
    proxyErrorHandler:(err,res,next)=>{
        ...
        res.status(500).json({
            message:`Internal server error`, error:err.message, err:err
        });
    }
};
...
app.listen(PORT, ()=>{
    ...
    logger.info(`Post service is running on port ${process.env.IDENTITY_SERVICE_URL}`);
